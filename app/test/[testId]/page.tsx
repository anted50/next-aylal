  ...
  return (
    <div >
      <section className="w-full flex-center flex-col py-2 space-y-2">
        ...
        <div className="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-[800px] sm:rounded-lg sm:px-10">
          <img className="mx-auto" src={info.URL} />
        </div>
